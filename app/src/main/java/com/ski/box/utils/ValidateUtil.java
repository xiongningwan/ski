...
public class ValidateUtil {
     ...
     * 汉子或者英文
     */
    public static final String STR_CHINESE_ENG_PATTERN = "^[\u4e00-\u9fa5_a-zA-Z]+$";

    /**
     * 汉子，英文或数字
     */
    public static final String STR_CHINESE_ENG_NUMBER_PATTERN = "^[\u4e00-\u9fa5_a-zA-Z0-9]+$";
     ...
     * 字母开头+数字或者字母
     */
    public static final String ACCOUNT_PATTERN = "^[a-zA-Z][a-zA-Z0-9]{5,11}$";
     ...
     * @param pwd
     * @return
     * @Description: 验证密码格式  6-12位  必须字母,数字.特殊符号组合
     */
    public static boolean validatePwd2(String pwd) {
        if (TextUtils.isEmpty(pwd)) {
            return Boolean.FALSE;
        }
        return Pattern.matches(PASSWORD_PATTERN2, pwd);
    }

    public static boolean validatePwd3(String pwd) {
        if (TextUtils.isEmpty(pwd)) {
            return Boolean.FALSE;
        }
        return Pattern.matches(PASSWORD_PATTERN3, pwd);
    }


    public static boolean validateAccount(String pwd) {
        if (TextUtils.isEmpty(pwd)) {
            return Boolean.FALSE;
        }
        return Pattern.matches(ACCOUNT_PATTERN, pwd);
    }
    ...
    public static boolean validateChineseAndEng(final String str) {
        if (TextUtils.isEmpty(str)) {
            return Boolean.FALSE;
        }
        return str.matches(STR_CHINESE_ENG_PATTERN);
    }

    public static boolean validateChineseEngNumber(final String str) {
        if (TextUtils.isEmpty(str)) {
            return Boolean.FALSE;
        }
        return str.matches(STR_CHINESE_ENG_NUMBER_PATTERN);
    }
