...
import static com.yb.core.utils.ScreenUtils.dp2px;
...
public class VerticalTab2Layout extends ScrollView {
    ...
    private boolean mTripCanScroll = true;
    ...
    public VerticalTab2Layout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mIndicatorWidth = (int) typedArray.getDimension(R.styleable.ski_VerticalTabLayout_ski_indicator_width, dp2px(context, 3));
        ...
        mTripCanScroll = typedArray.getBoolean(R.styleable.ski_VerticalTabLayout_ski_tab_trip_scroll, true);
    ...
    private void setTabSelected(final boolean isOnclick, final int position, final boolean updataIndicator, final boolean callListener) {
        post(() -> setTabSelectedImpl(isOnclick, position, updataIndicator, callListener));
    }
    ...
    private void setTabSelectedImpl(final boolean isOnclick, final int position, boolean updataIndicator, boolean callListener) {
        ...
        /*不滚动时直接设置背景*/
        if (!mTripCanScroll) {
            view.setBackground(mIndicatorResId);
        }
        boolean selected;
        ...
        if (selected = (view != mSelectedTab)) {
            if (mSelectedTab != null) {
                ...
                mSelectedTab.setBackground(null);
            }
//            view.setChecked(true);
            if (updataIndicator && mTripCanScroll) {
...
//                nextView.setChecked(false);
    ...
    private class OnTabPageChangeListener extends ViewPager2.OnPageChangeCallback {
        ...
        public void onPageScrolled(int position, float positionOffset,
            ...
            if (mUpdataIndicator && mTripCanScroll) {
