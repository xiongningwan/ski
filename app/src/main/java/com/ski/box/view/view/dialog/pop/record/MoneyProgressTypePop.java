...
public class MoneyProgressTypePop extends BasePopup<MoneyProgressTypePop> implements View.OnClickListener {
    ...
    public static MoneyProgressTypePop create(Context context) {
        return new MoneyProgressTypePop(context);
    }

    protected MoneyProgressTypePop(Context context) {
        setContext(context);
        mContext = context;
    }
    ...
    @Override
    protected void initViews(View view, MoneyProgressTypePop recordDatePop) {
...
//        list.add(new ConditionBean("奖金超限扣款", MoneyAdapter.TYPE_CONTENT, "7", false));
        ...
        mMoneyAdapter.setNewInstance(list);
    }
